...
import { ServiceCard, Service } from './components/service-card/service-card';
import { Testimonials } from './components/testimonials/testimonials';
import { CommonModule } from '@angular/common';

@Component({
  selector: 'app-root',
  imports: [RouterOutlet, ContactForm, ServiceCard, Testimonials, CommonModule],
  templateUrl: './app.html',
  styleUrl: './app.scss'
})
export class App implements OnInit {
  protected readonly title = signal('sorella-home-solutions');
